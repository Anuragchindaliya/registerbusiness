...
const Hero = ({ singleBusiness: [data] }) => {
    return (
        <>
            {/* second */}
            <section className="hero" style={{ backgroundImage: 'url("/images/first.jpg")' }}>
                <div className="px-4 py-5 my-5 text-center text-white" style={{ backgroundColor: 'rgba(0,0,0,.5)' }}>
                    <Image className="brand-logo d-block mx-auto mb-4" src={`/images/${data.img}`} alt="" width={100} height={100} />
                    <h1 className="display-5 fw-bold">{data.firm_name}</h1>
                    <div className="col-lg-6 mx-auto">
                        <p className="lead mb-4">{data.subhead} <br />Available All Time</p>
